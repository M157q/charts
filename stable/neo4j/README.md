...
| `service.exposeHttpPort`             | Expose default Http port (7474) or not?                                                                                                 | `true`                                          |
| `service.exposeBoltPort`             | Expose default Bolt port (7687) or not?                                                                                                 | `false`                                         |
| `core.numberOfServers`               | Number of machines in CORE mode                                                                                                         | `3`                                             |
| `core.heapInitialSize`               | Initial heap size of core pod                                                                                                           | `512M`                                          |
| `core.heapMaxSize`                   | Maximum heap size of core pod                                                                                                           | `512M`                                          |
...
| `readReplica.heapInitialSize`        | Initial heap size of read replica pod                                                                                                   | `512M`                                          |
| `readReplica.heapMaxSize`            | Maximum heap size of read replica pod                                                                                                   | `512M`                                          |
